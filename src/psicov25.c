...
{
    int             a, b, i, j, k, seqlen, nids, s, nseqs, ncon, opt, ndim, filtflg=0, approxflg=0, initflg=0, apcflg=1, maxit=20, npair, nnzero, niter, jerr, shrinkflg=1, rawscflg = 1, pseudoc = 1, minseqsep = 5, overrideflg=0, ntries;
...
//	fprintf(stderr, "rho=%f fnzero = %f targdiff = %f\n", trialrho, fnzero, targdiff);
